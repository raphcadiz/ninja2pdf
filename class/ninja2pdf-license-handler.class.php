...
class Ninja2PDF_License_Handler {
    private $file;
    private $license;
    private $item_name;
    private $item_id;
    ...
    private function includes() {
        if ( ! class_exists( 'EDD_SL_Plugin_Updater' ) )  {
            require_once(N2PDF_PATH_CLASS . '/EDD_SL_Plugin_Updater.php');
        }
    }
    ...
    private function hooks() {
        ...
        add_action( 'ninja2pdf_weekly_scheduled_events', array( $this, 'weekly_license_check' ) );
